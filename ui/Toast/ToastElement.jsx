...
const ToastElement = ({ toast, removeToast }) => {
  ...
  return (
    <motion.div
      layout
      className="w-fulltext-slate-50 relative flex overflow-hidden rounded-sm bg-slate-800 px-4 py-2 pl-3 shadow-lg shadow-slate-900"
      animate={{
        opacity: 1,
        left: '0%',
      }}
    ...
    >
      ...
      {TYPE.loading !== toast.type && (
        <div
          ref={progressRef}
          className={clsx('absolute bottom-0 left-0 h-0.5 bg-white', {
